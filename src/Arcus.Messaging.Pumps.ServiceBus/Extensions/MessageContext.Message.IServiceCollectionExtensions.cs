...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static partial class IServiceCollectionExtensions
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown when the <paramref name="services"/>, <paramref name="messageContextFilter"/>, or <paramref name="messageFilter"/> is <c>null</c>.</exception>
            ...
            where TMessage : class
        {
            ...
            return services.WithMessageHandler<TMessageHandler, TMessage, AzureServiceBusMessageContext>(
                messageContextFilter, messageFilter, serviceProvider => ActivatorUtilities.CreateInstance<TMessageHandler>(serviceProvider));
        }
        ...
        /// <exception cref="ArgumentNullException">Thrown when the <paramref name="services"/>, <paramref name="messageContextFilter"/>, <paramref name="messageFilter"/>, or <paramref name="implementationFactory"/> is <c>null</c>.</exception>
        public static IServiceCollection WithServiceBusMessageHandler<TMessageHandler, TMessage>(
            this IServiceCollection services,
            Func<AzureServiceBusMessageContext, bool> messageContextFilter,
            Func<TMessage, bool> messageFilter,
