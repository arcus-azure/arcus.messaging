...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private async Task DeadLetterMessageNoHandlerRegisteredAsync(ServiceBusMessageContext messageContext)
        {
        ...
        private async Task DeadLetterMessageNoHandlerMatchedAsync(ServiceBusMessageContext messageContext)
        {
        ...
        private async Task AbandonMessageMatchedHandlerFailedAsync(ServiceBusMessageContext messageContext)
        {
