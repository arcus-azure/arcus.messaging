...
namespace Arcus.Messaging.Abstractions.EventHubs.MessageHandling
{
    ...
    /// and possible additional configurations that can be configured with the current state of the Azure EventHubs instance.
    /// </summary>
    public class EventHubsMessageHandlerCollection : MessageHandlerCollection
    {
        ...
        /// </summary>
        /// <param name="services">The current available collection services to register the Azure EventHubs message handling logic into.</param>
