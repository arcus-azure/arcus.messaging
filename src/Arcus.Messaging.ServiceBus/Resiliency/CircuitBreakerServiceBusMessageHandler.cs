...
namespace Arcus.Messaging.Pumps.ServiceBus.Resiliency
{
    ...
    /// </summary>
    /// <typeparam name="TMessage">The type of the message that this handler can process.</typeparam>
    [Obsolete("Will be removed in v4.0, please implement the Arcus.Messaging." + nameof(DefaultCircuitBreakerServiceBusMessageHandler<object>) + " one instead", DiagnosticId = ObsoleteDefaults.DiagnosticId)]
