...
namespace Arcus.Messaging.Pumps.Abstractions
{
    ...
    public abstract class MessagePump : BackgroundService
    {
        ...
        [Obsolete("Consider using the " + nameof(IServiceCollectionExtensions.AddMessageRouting) + " instead to register an " + nameof(IMessageRouter) + " implementation that you can use directly in your message pump")]
