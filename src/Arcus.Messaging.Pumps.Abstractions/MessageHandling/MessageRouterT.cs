...
namespace Arcus.Messaging.Pumps.Abstractions.MessageHandling
{
    ...
    /// </summary>
    public class MessageRouter<TMessageContext> : IMessageRouter<TMessageContext> 
        where TMessageContext : MessageContext
    {
        private readonly Lazy<IFallbackMessageHandler> _fallbackMessageHandler;

        /// <summary>
        /// Initializes a new instance of the <see cref="MessageRouter{TMessageContext}"/> class.
        /// </summary>
        ...
        public MessageRouter(
            ...
            ILogger<MessageRouter<TMessageContext>> logger)
        ...
        public MessageRouter(IServiceProvider serviceProvider, ILogger logger)
        {
            ...
            Logger = logger ?? NullLogger<MessageRouter<TMessageContext>>.Instance;
        ...
        protected async Task<bool> ProcessMessageWithoutPotentialFallbackAsync(
            string message,
        ...
        /// </exception>
        /// <exception cref="InvalidOperationException">Thrown when no message handlers or none matching message handlers are found to process the message.</exception>
        public virtual async Task ProcessMessageAsync(
            string message,
            TMessageContext messageContext,
            MessageCorrelationInfo correlationInfo,
            CancellationToken cancellationToken)
        ...
        protected async Task<MessageResult> DeserializeMessageForHandlerAsync(string message, TMessageContext messageContext, MessageHandler handler)
         {
