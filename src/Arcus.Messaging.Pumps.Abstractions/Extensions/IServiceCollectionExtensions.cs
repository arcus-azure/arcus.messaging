...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// Adds an <see cref="IMessageBodyHandler"/> implementation which the message pump can use to
        ...
        /// <exception cref="ArgumentNullException">Thrown when the <paramref name="services"/> is <c>null</c>.</exception>
        public static IServiceCollection WithMessageBodyHandler<TMessageBodyHandler>(this IServiceCollection services) 
            where TMessageBodyHandler : class, IMessageBodyHandler
        {
            Guard.NotNull(services, nameof(services), "Requires a services collection to add the message body handler to");

            return services.AddSingleton<IMessageBodyHandler, TMessageBodyHandler>();
        }
        ...
        /// <exception cref="ArgumentNullException">Thrown when the <paramref name="services"/> or the <paramref name="createImplementation"/> is <c>null</c>.</exception>
        public static IServiceCollection WithMessageBodyHandler<TMessageBodyHandler>(
            this IServiceCollection services,
            ...
            where TMessageBodyHandler : class, IMessageBodyHandler
        {
            ...
            return services.AddSingleton<IMessageBodyHandler, TMessageBodyHandler>(createImplementation);
        }
    }
}
