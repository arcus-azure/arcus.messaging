...
{
    public class AzureFunctionsInProcessMessageCorrelationTests
    {
        [Fact]
        public void Correlate_WithDefault_Succeeds()
        {
            ...
            var correlation = new AzureFunctionsInProcessMessageCorrelation(client);
        ...
        {
            Assert.ThrowsAny<ArgumentException>(() => new AzureFunctionsInProcessMessageCorrelation(client: null));
        }
    }
}
