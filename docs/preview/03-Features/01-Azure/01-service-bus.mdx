...
Now Arcus will use the Serilog approach to track Azure Service Bus messages. Make sure that Microsoft's  `TelemetryClient` is registered in the application services.
