...
By deafult, when registering the Azure Service Bus message pump with `AddServiceBusXxxMessagePump`, a built-in message router is registered to handle the routing throughout the previously registered message handlers.
